...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row" id="margin-del">
			...
			<div class="col-sm-7"
				style="background-color: white; margin-top: 60px; min-height: 700px;">
				<div style="margin-left: 85px; margin-top: 40px;">
					<span
						style="font-size: 2.1rem; color: rgb(5, 33, 63); font-weight: 480;">講義中の講義</span>
					<br> <br>
					<div class="subjectList"
						style="background-color: #f7f9fa85; width: 90%; padding: 10px; border: 1.1px solid #aeafaf;">
						<ul
							style="list-style-type: none; list-style-position: inside; margin-left: 30px;">
							<li class="menu"><a
								style="border-bottom: 1px solid gray; width: 70%;"><img
									src="" />講義中の科目<span
									style="right: -110%; position: relative; color: #aeafaf;">▽</span></a>
								<ul class="hide"
									style="list-style-type: none; list-style-position: inside;">
									<c:forEach items="${subjectList}" var="subject">
										<li><a style="text-indent: 20px;"
											href="/subjectDetail?lecturenum=${subject.LECTURENUM}">${subject.NAME}(${subject.OCCUPANCY})</a></li>
									</c:forEach>
								</ul></li>
						</ul>
					</div>
					...
					<div class="notice">
						<span
							style="font-size: 1.8rem; color: rgb(5, 33, 63); font-weight: 480; margin-right: 20px;">お知らせ</span>
						<span style="position: relative; top: -6px; color: #727c87">|</span>
						<span
							style="font-size: 1.8rem; color: #62666a; font-weight: 480; margin-left: 20px;">学校日程</span>
						<hr style="width: 90%;">
						<div id="qTable">
							<table
								...
								<tbody style="font-size: 1.25rem;">
									<c:if test="${newList!=null}">
										<c:forEach var="news" items="${newList}" step="1" begin="0"
											end="5">
			...
			<div class="col-sm-3"
				style="background-color: #f7f9fa; margin-top: 60px;">
				<div style="margin-left: 20px; margin-top: 40px;">
<!-- 					<button id="register" -->
<!-- 						style="float: left; border-radius: 2px; width: 90%; margin: 0 auto; padding-top: 20px; padding-bottom: 20px;">受講申し込み</button> -->
<!-- 					<br> <br> -->
<!-- 					<br>  -->
					<span
						style="font-size: 2.1rem; font-weight: 480; color: rgb(5, 33, 63);">
						- 講義時刻表</span>
					<div class="subjectList"
						style="background-color: #f7f9fa85; width: 90%; padding: 10px; border: 1.1px solid #aeafaf;">
						<table class="timetableTable1" style="float: left;">
							<tbody style="border-right: 1px solid gray; font-size: 5px;"
								id="tTbody">
								<tr>
									<td style="border-bottom: 1px solid gray; height: 31.2px;">備考</td>
								</tr>
								<tr>
									<td>9:00</td>
								</tr>
						...
						<table style="width: 89%; font-size: 5px;">
							...
							<tbody>
								<c:forEach items="${timetable}" var="time1" begin="0" step="1"
									end="22" varStatus="index">
									<tr>
										<c:forEach items="${time1}" var="time2" begin="0" step="1"
											end="4">
											<c:choose>
												<c:when test="${time2 == ' ' || time2 == null || time2 ==''}">
