  ...
  <div class="container-fluid">
   <header>
     <div class="d-none d-lg-block" id="fix-title">
       <div id="fix-logoDiv">
       <div id="fix-logo">
         <a href="#"> <img id="schoolLogo" src="<c:url value="/resources/img/logo.png" />" alt=""> 
           <span id="sideLogo"> 知恵通信大学 </span>
         </a>
       </div>
       </div>
       <div id="fix-text">個人情報変更</div>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav">
							...
							<li class="nav-item">
								<a class="nav-link js-scroll-trigger" href="/consultList">相談管理</a></li>
			</ul>
		</div>
	</nav>
		...
		<div class="col-sm-9" id="hiddenright">
			...
			<div id="conte">
				...
				<div class="table-responsive">
					...
					<table class="table table-striped">
						...
						<tbody id = "context">
							...
							<tr class="table-title">
								...
								<td class = "cont1">地位</td>
								<td class = "cont2">${USER.JTITLE}</td>
							</tr>
							<tr class="table-title">
								<td class = "cont1">入社日子</td>
								<td class = "cont2">${USER.ENTERDATE}</td>
								<td class = "cont1">担当科目</td>
								<td class = "cont2">${USER.JSUBJECT}</td>
							</tr>
							<tr class="table-title">
							...
							<tr class="table-title" style="border-bottom: 1px solid #dee2e6;">
								<td colspan="5" style="text-align: left; font-weight: 400; font-size: 0.95rem; border-top: none; border-right: none;">* 下の入力欄の情報は学生に<span style="color: red;">公開</span>されます。</td>
							</tr>
							<tr class="table-title">
								<td class = "cont1">電話番号</td>
								<td class = "cont2" colspan="4">
								<span class="telSpan" style="height: 25px;"> </span>
								<input type="text" value="${USER.TEL4}" id="tel4" name ="tel4" class="myInfoTel" required="required">
								<span class="telSpan">-</span>
								<input type="text" value="${USER.TEL5}" id="tel5" name ="tel5" class="myInfoTel" required="required">
								<span class="telSpan">-</span>
								<input type="text" value="${USER.TEL6}"  id="tel6" name ="tel6" class="myInfoTel" required="required">									
								</td>
							</tr>
							<tr class="table-title" style="border-bottom: 1px solid #dee2e6;">
								<td class = "cont1">イーメール</td>
								<td class = "cont2" colspan="4"><input type="email" name ="jemail" value="${USER.JMAIL}" id="jemail" style="border: 1px solid #dee2e6;  padding-left : 7px; padding-right : 7px; width: 95%;"></td>
							</tr>
						</tbody>
					...
					<button id="counsel" type="button" style="width: 22%; float: left">相談可能時間変更</button>
...
$(function() {
  ...
  function apply(){
	  ...
	  var tel2 = $("#tel4").val() + $("#tel5").val() + $("#tel6").val();
	  formData.append("jtel",tel2);
	  formData.append('jmail',$("#jmail").val());
	  $.ajax({
	        type : 'POST'
	        ,url : 'UpdateMyinfo'
	        ,processData : false
   ...
   function counsel(){
	   window.open('counselChange', '_blank', 'channelmode=yes, location=no, menubar=no,scrollbars=no', false);
   }
