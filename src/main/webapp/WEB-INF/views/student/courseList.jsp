...
<body>
  ...
  <div class="container-fluid">
	...
	<hr style="width: 95%;">
	<div id="conte">
		<h4>今学期に受講を申し込んだ講義です。講座をクリックして授業に参加できます。</h4>
		<br>
              ...
              <table class="table table-striped">
                <thead class="thead">
                  <tr id="table-title" style="background-color: rgb(240,240,240)">
                    ...
                    <th style="width:15%; border-left: 1px solid #dee2e6;">教授</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:15%; text-align: center"><img class="listPicture" src="${subject.PPICTURE}"><br>${subject.PNANE}</td>
