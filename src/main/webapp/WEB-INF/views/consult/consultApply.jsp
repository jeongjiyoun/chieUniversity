    ...
    <div class="row" id="margin-del">
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top"
			...
			<div class="col-sm-9" id="hiddenright">
				...
				<div id="conte">
					<h4>相談を申し込むことができます。教授を選び、日子と理由を記入してください。</h4>
					<br>
            <br>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab2">
                    <form method="POST" action="consultApply" id="consultForm">
                      <div class="row row-space">
                        <div class="col-2">
                          <div class="input-group">
                            <label class="label">教授名 </label>
                            <div class="rs-select2 js-select-simple select--no-search">
                              <select id="preginum" name="preginum">
                                <c:forEach items="${proList}" var="professor">
                                <option value="${professor.PREGINUM}">${professor.NAME}</option>
                              　					</c:forEach>
                            </select>
                    ...
                    <div class="row row-space">
                      <div class="col-2">
                        <div class="input-group">
                          <label class="label">相談日</label> <input
                          class="input--style-1 js-single-datepicker" type="text"
                          name="coundate" placeholder="dd/mm/yyyy" data-drop="1"
                          id="coundate">
