...
<script type="text/javascript">
        	...
        	var sendUpFileToServer = function() {
        		$.ajax({
        			type : "post",
        			url : "updateNoticeUpload", //Upload URL
        			data : fd,
        			contentType : false,
        			processData : false,
        			cache : false,
        			success : function(data) {
        				if(data==null) {
        					...
        					//alert('성공');
        					location.href='./showNotice?lnSeq='+lnSeq;
        				}
        			}
        		});
        	}
				...
				<%--                         <c:if test="${sessionScope.userType == 'P'}"> --%>
                        <section id="SubjectNotice">
                           ...
                           <div id="noticeWriteS">
                                 ...
                                 TITLE:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title" id="title" value="${notice.title}" readonly="readonly"><br><br>
						   ...
						   <br>
						   		...
						   		<table id='fileTable'>
						   			...
						   			<tr>
						   			 <td>${noti.org_Name}</td>
							            <td></td>
							            <td><button type='button' onclick="delFile2(this)" class='canclebut1' name="fileSeq" id="fileSeq" value="${noti.fileSeq}">delete</button> </td>
						   			</tr>
						   			</c:forEach>
                           ...
                           <input type="hidden" name="lnSeq" id="lnSeq" value="${notice.lnSeq}">
