...
<script type="text/javascript">
        	...
        	function submitFile(){
        			...
        			fd.append('assSeq',$('#assSeq').val());
        			fd.append('aSubSeq',$('#aSubSeq').val());
        	...
        	var sendUpFileToServer = function() {
        		$.ajax({
        			type : "post",
        			url : "updateAssignSUpload", //Upload URL
        			data : fd,
        			contentType : false,
        			processData : false,
        			cache : false,
        	...
        	function delFile2(e) {
        		...
        		fd.delete(formName);
        		//맵에서도 올린 파일의 정보를 삭제한다.
        		var fileASeq = e.value;
        		
        		$.ajax({
        			url:"delAssignSF",
        			type:"post",
        			data:{fileASeq:fileASeq},
        			success:function(data){
        				if(data){
        					// tr을 삭제하기 위해
        	        		$(e).parents('tr').remove();
				...
				<%--                         <c:if test="${sessionScope.userType == 'P'}"> --%>
                        <section id="SubjectNotice">
                           ...
                           <div id="noticeWriteS">
                                 ...
                                 TITLE:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title" id="title" value="${assignS.title}" readonly="readonly"><br><br>
						   ...
						   <br>
						   		...
						   		<table id='fileTable'>
						   			...
						   			<c:forEach var="aSub" items="${aList}">
						   			<tr>
						   			 <td>${aSub.org_Name}</td>
							            <td></td>
							            <td><button type='button' onclick="delFile2(this)" class='canclebut1' name="fileASeq" id="fileASeq" value="${aSub.fileASeq}">delete</button> </td>
						   			</tr>
						   			</c:forEach>
                           ...
                           <input type="hidden" name="aSubSeq" id="aSubSeq" value="${assignS.aSubSeq}">
                           <input type="hidden" name="assSeq" id="assSeq" value="${assignS.assSeq}">
