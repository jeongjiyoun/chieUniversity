...
<script type="text/javascript">
        	...
        	function submitFile(){
        			...
        			contents = CKEDITOR.instances["contents1"].getData();
            ...
            <li class="nav-item"><a class="nav-link js-scroll-trigger"
               ...
               <div class="col-sm-9" id="hiddenright">
				...
				<%--                         <c:if test="${sessionScope.userType == 'S'}"> --%>
                        <section id="StudentAssign">
                           <h2>書く</h2>
                           <br>
                           <div id="assignWriteS">
                             
                              <form action="submitAssignS" method="post">
                              
                                 TITLE:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title" id="title"><br><br>
                                 
             
                              <textarea name="contents1" id="contents1" rows="10" cols="103">
